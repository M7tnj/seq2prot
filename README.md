...
```
virus-genomic-analyzer/
├── README.md                                    # This file
├── requirements.txt                             # Python dependencies
├── config.py                                    # Pipeline configuration
│
├── 📓 Notebooks
│   ├── Virus_Genomic_Variant_Analysis_Beginners_Guide.ipynb          # Phase 1 (Steps 0–6)
│   └── Virus_Genomic_Variant_Analysis_Phase2_Beginners_Guide.ipynb  # Phase 2 (Steps 7–14)
│
├── 📊 Assets (Visualizations)
│   └── assets/
│       ├── pipeline_flow.gif              # Animated pipeline flow
│       ├── pipeline_architecture.png      # Full pipeline diagram
│       ├── data_flow.png                  # Data flow diagram
│       ├── variant_distribution.png       # Variant type donut chart
│       ├── enrichment_chart.png           # Pathway enrichment bubbles
│       ├── structure_deviation.png        # Per-residue + metrics
│       ├── drug_resistance.png            # Resistance profile + pie
│       ├── phylogenetic_tree.png          # NJ tree with bootstrap
│       ├── epitope_map.png                # Domain + epitope overlay
│       └── surveillance_dashboard.png     # dN/dS + entropy + trends
│
├── 🔧 Source Code (Production Modules)
│   ├── convert_to_fastq.py                # Step 0: Sanger → FASTQ
│   ├── main.py                            # Pipeline orchestrator
│   ├── demo.py                            # Demo data generator
│   │
│   ├── parsers/
│   │   └── fastq_parser.py                # Step 1: FASTQ parsing & QC
│   ├── ncbi/
│   │   └── blast_client.py                # Step 2: BLAST identification
│   ├── alignment/
│   │   └── aligner.py                     # Step 4: Smith-Waterman alignment
│   ├── variants/
│   │   └── variant_caller.py              # Step 4: Variant calling
│   ├── annotation/
│   │   └── database_annotator.py          # Step 5: Functional annotation
│   ├── uniprot/
│   │   └── uniprot_client.py              # Step 9: Protein characterization
│   ├── reports/
│   │   └── xlsx_reporter.py               # Step 6/8: Report generation
│   └── utils/
│       └── helpers.py                     # Utility functions
│
└── 📁 Output
    ├── virus_reports/                     # Generated reports
    └── demo_reports/                      # Demo output files
```
